...
class UserWithRolesServiceTest {
  ...
  void getUserWithRoles() {
    ...
    assertEquals(2, user.getRoleNames());
  ...
  void addRole() {
    ...
    assertEquals(1, user.getRoleNames());
    assertTrue(user.getRoleNames().contains("STUDENT"));
  }
  ...
  void removeRole() {
    ...
    assertEquals(0, user.getRoleNames());
  }
  ...
  void addUserWithRolesWithNoRole() {
    ...
    assertEquals(0, newUser.getRoleNames());
  ...
  void addUserWithRolesWithRole() {
    ...
    assertEquals(1, newUser.getRoleNames());
